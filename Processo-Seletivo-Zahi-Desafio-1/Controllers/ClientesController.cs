...
namespace Processo_Seletivo_Zahi_Desafio_1.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Client_ID,Client_Name")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Client_ID,Client_Name")] Cliente cliente)
        {
            if (ModelState.IsValid)
            {
